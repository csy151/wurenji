    ...
    <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="用户类型" align="center" prop="userType">
        <template #default="scope">
          <dict-tag :options="sys_common_status" :value="scope.row.userType"/>
        </template>
      </el-table-column>
...
const { sys_common_status, sys_yes_no, sys_user_sex } = proxy.useDict('sys_common_status', 'sys_yes_no', 'sys_user_sex');
...
function handleExport() {
  proxy.download('manage/user/export', {
    ...queryParams.value
